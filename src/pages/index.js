  ...
  return (
    <div className="container mx-auto p-4 flex flex-col items-center justify-center h-screen">
      ...
      <div className="flex mb-4">
          ...
          />
          <button className="bg-purple-500 hover:bg-blue-600 text-white px-4 py-1 rounded-md" onClick={handlePush}>
  Push
</button>
<button className="bg-pink-500 hover:bg-red-600 text-white px-4 py-1 rounded-md ml-2" onClick={handlePop}>
  Pop
</button>
        </div>
        {stack.length === 0 ? (
